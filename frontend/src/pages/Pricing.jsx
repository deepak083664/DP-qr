...
const Pricing = () => {
  ...
  const planFeatures = {
    ...
    '3_months': { name: '3 Months Plan', price: plans.threeMonthsPrice, isBestValue: true, features: ['3 editable QR codes (dynamic)', 'Valid till 3 months', 'Advanced edit option', 'QR edit, delete, track options', 'Advance analytics'] },
    '1_year': { name: '1 Year Plan', price: plans.oneYearPrice, features: ['5 editable QR codes (dynamic)', 'Valid till 1 year', 'Advanced edit option', 'QR add, delete, track options', 'Dedicated support', 'Advance analytics'] }
  };
